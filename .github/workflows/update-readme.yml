...
# Caminho base para o diretório onde está este script
...
README_FILE = os.path.join(BASE_DIR, "documentos", "README.md")  # ← Atualizado
...
def gerar_readme(versao, data_hora):
    # Garante que o diretório "documentos/" existe
