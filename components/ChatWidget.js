      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <span className={styles.textBubble}>Bem-vindo! Sou o 🤖 IAGRO, seu assistente virtual especializado no agronegócio. Vamos esclarecer suas dúvidas sobre o agro?</span>
            <Image
